...
def rk4_bk_1d_ensemble(N,n_mem,theta_in,u_in,v_in,dt,q_vector):
    ...
    dudt=v_00
    dvdt= (gamma_mu**2)*(u_n1-2*u_00+u_p1) \
                    -(gamma_lambda**2)*u_00 -((gamma_mu**2)/(xi))*(f+theta_00+np.log(v_00+1))+q_vector*v_00
...
filename_estimate_theta='./results_rmse/rmse_theta_bk1d_radiation_damping_obs_den_'+str(obs_den).zfill(2)+'_run_'+name_exp+'.txt'
...
filename_estimate_u='./results_rmse/rmse_u_bk1d_radiation_damping_obs_den_'+str(obs_den).zfill(2)+'_run_'+name_exp+'.txt'
...
filename_estimate_v='./results_rmse/rmse_v_bk1d_radiation_damping_obs_den_'+str(obs_den).zfill(2)+'_run_'+name_exp+'.txt'
...
filename_estimate_tau='./results_rmse/rmse_tau_bk1d_radiation_damping_obs_den_'+str(obs_den).zfill(2)+'_run_'+name_exp+'.txt'
...
filename_rank_hist='./results_rank_hist/rank_hist_bk1d_radiation_damping_obs_den_'+str(obs_den).zfill(2)+'_run_'+name_exp+'.txt'
np.savetxt(filename_rank_hist,rank_hist_summary)

filename_samples_v='./results_rank_hist/samples_v_hist_bk1d_radiation_damping_obs_den_'+str(obs_den).zfill(2)+'_run_'+name_exp+'.txt'
np.savetxt(filename_samples_v,samples_v)

filename_samples_tau='./results_rank_hist/samples_tau_hist_bk1d_radiation_damping_obs_den_'+str(obs_den).zfill(2)+'_run_'+name_exp+'.txt'
