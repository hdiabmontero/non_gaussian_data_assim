...
folder_prior='/home/hamed/Data Assimilation Methods/data/bk_rsf_1d/BK_RSF_1D_test_datasets_chaotic/prior/'
...
filename_estimate_theta='./results_rmse_test/rmse_theta_bk1d_model_error_obs_den_'+str(obs_den).zfill(2)+'_run_'+name_exp+'.txt'
...
filename_estimate_u='./results_rmse_test/rmse_u_bk1d_model_error_obs_den_'+str(obs_den).zfill(2)+'_run_'+name_exp+'.txt'
...
filename_estimate_v='./results_rmse_test/rmse_v_bk1d_model_error_obs_den_'+str(obs_den).zfill(2)+'_run_'+name_exp+'.txt'
...
filename_estimate_tau='./results_rmse_test/rmse_tau_bk1d_model_error_obs_den_'+str(obs_den).zfill(2)+'_run_'+name_exp+'.txt'
