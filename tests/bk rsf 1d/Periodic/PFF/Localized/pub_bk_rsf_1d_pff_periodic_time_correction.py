...
folder_truth='/palmyra/data/hadiabmontero/non_gaussian_data_assim/data/bk_rsf_1d/BK_RSF_1D_datasets_periodic/truth/'
...
obs_rate = 450     # interval of time steps between observations
...
folder_obsnet='/palmyra/data/hadiabmontero/non_gaussian_data_assim/data/bk_rsf_1d/BK_RSF_1D_datasets_periodic/obsnet/'
...
folder_prior='/palmyra/data/hadiabmontero/non_gaussian_data_assim/data/bk_rsf_1d/BK_RSF_1D_datasets_periodic/prior/'
...
while t*tstep < t_assim*tstep:
    ...
    post_pff = pff(n_mem, n_x*N, X_da_prior, y_t[:,0], index_pff)
...
filename_estimate_theta='./results_rmse/rmse_theta_bk1d_periodic_obs_den_'+str(obs_den).zfill(2)+'_run_'+name_exp+'.txt'
...
filename_estimate_u='./results_rmse/rmse_u_bk1d_periodic_obs_den_'+str(obs_den).zfill(2)+'_run_'+name_exp+'.txt'
...
filename_estimate_v='./results_rmse/rmse_v_bk1d_periodic_obs_den_'+str(obs_den).zfill(2)+'_run_'+name_exp+'.txt'
...
filename_estimate_tau='./results_rmse/rmse_tau_bk1d_periodic_obs_den_'+str(obs_den).zfill(2)+'_run_'+name_exp+'.txt'
...
filename_rank_hist='./results_rank_hist/rank_hist_bk1d_periodic_obs_den_'+str(obs_den).zfill(2)+'_run_'+name_exp+'.txt'
np.savetxt(filename_rank_hist,rank_hist_summary)

filename_samples_v='./results_rank_hist/samples_v_hist_bk1d_periodic_obs_den_'+str(obs_den).zfill(2)+'_run_'+name_exp+'.txt'
np.savetxt(filename_samples_v,samples_v)

filename_samples_tau='./results_rank_hist/samples_tau_hist_bk1d_periodic_obs_den_'+str(obs_den).zfill(2)+'_run_'+name_exp+'.txt'
