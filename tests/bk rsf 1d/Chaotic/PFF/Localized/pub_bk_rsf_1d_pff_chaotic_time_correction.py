...
folder_truth='/palmyra/data/hadiabmontero/non_gaussian_data_assim/data/bk_rsf_1d/BK_RSF_1D_datasets_chaotic/truth/'
...
folder_obsnet='/palmyra/data/hadiabmontero/non_gaussian_data_assim/data/bk_rsf_1d/BK_RSF_1D_datasets_chaotic/obsnet/'
...
folder_prior='/palmyra/data/hadiabmontero/non_gaussian_data_assim/data/bk_rsf_1d/BK_RSF_1D_datasets_chaotic/prior/'
...
filename_rank_hist='./results_rank_hist/rank_hist_bk1d_chaotic_obs_den_'+str(obs_den).zfill(2)+'_run_'+name_exp+'.txt'
np.savetxt(filename_rank_hist,rank_hist_summary)

filename_samples_v='./results_rank_hist/samples_v_hist_bk1d_chaotic_obs_den_'+str(obs_den).zfill(2)+'_run_'+name_exp+'.txt'
np.savetxt(filename_samples_v,samples_v)

filename_samples_tau='./results_rank_hist/samples_tau_hist_bk1d_chaotic_obs_den_'+str(obs_den).zfill(2)+'_run_'+name_exp+'.txt'
